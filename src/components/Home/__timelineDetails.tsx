...
const timelineDetails = [
  {
    timeline_title: "fastn Roadshow Kathmandu",
    timeline_description: "",
    timeline_icon: <SiChainlink />,
    timeline_place: "Kathmandu",
    timeline_date: "19th August 2020",
    timeline_day: "Saturday",
    timeline_hostedby: "Rajkumar Aryal",
    timeline_event_link: "",
    timeline_tags: [
      { tag: "fastn" },
      { tag: "Framework" },
  ...
  },
  {
    ...
    timeline_date: "12th August 2021",
    timeline_day: "Sunday",
    timeline_hostedby: "Rajkumar Aryal",
    timeline_event_link: "",
    timeline_tags: [
  ...
  {
    timeline_title: "fastn Roadshow Dhading",
    timeline_description: "",
    timeline_icon: <IoIosRocket />,
    timeline_place: "Simle",
    timeline_date: "06th June 2023",
    timeline_day: "Sunday",
    timeline_hostedby: "Rajkumar Aryal",
    timeline_event_link: "https://www.facebook.com/rajkumararyal0977",
    timeline_tags: [
      { tag: "fastn" },
      { tag: "Framework" },
      { tag: "Open Source" },
  ...
  {
    timeline_title: "fastn Roadshow Nuwakot",
    timeline_description: "",
    timeline_icon: <MdTimeline />,
    timeline_place: "Battar",
  ...
  {
    timeline_title: "fastn Roadshow Lalitpur",
    timeline_description: "",
  ...
  {
    timeline_title: "fastn Roadshow Balaju",
    timeline_description: "",
    timeline_icon: <MdTimeline />,
    timeline_place: "Lucknow",
    timeline_date: "24th June 2022",
    timeline_day: "Saturday",
    timeline_hostedby: "Rajkumar Aryal",
    timeline_event_link: "https://www.facebook.com/rajkumararyal0977",
    timeline_tags: [
  ...
  {
    timeline_title: "fastn Roadshow Newroad",
    timeline_description: "",
    timeline_icon: <SiChainlink />,
    timeline_place: "Bhopal",
    timeline_date: "17th June 2022",
    timeline_day: "Saturday",
    timeline_hostedby: "Rajkumar Aryal",
    timeline_event_link: "https://www.facebook.com/rajkumararyal0977",
    timeline_tags: [
  ...
  {
    timeline_title: "DevRel Meetup in kathmandu",
    timeline_description: "",
    timeline_icon: <MdEventAvailable />,
    timeline_place: "Kalanki",
  ...
  {
    timeline_title: "JavaSript Conference Nepal 2023",
    timeline_description: "",
    timeline_icon: <IoIosRocket />,
    timeline_place: "Bangalore",
    timeline_date: "2nd June 2023",
    timeline_day: "Friday",
    timeline_hostedby: "JS Conference Nepal",
  ...
  },
  {
    ...
    timeline_place: "Microsoft Reactor, UAE",
